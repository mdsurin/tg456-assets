...
(function(){
 ...
 function install(){
  ...
  const style=el('style','');style.textContent=`#tg456-withdrawals{padding:0;margin:12px auto;border:0;border-radius:0;background:transparent;box-shadow:none;max-width:1440px;width:100%;min-width:0;color:#f8f5ff;font-family:Tahoma,Arial,sans-serif;overflow:hidden}#tg456-withdrawals *{box-sizing:border-box}#tg456-withdrawals .tw-head{display:flex;align-items:center;gap:10px;background:linear-gradient(100deg,#762bc0,#34144e 65%,transparent);border-radius:22px;padding:7px 12px;margin-bottom:8px}#tg456-withdrawals h2{font-size:15px;margin:0;flex:1;color:#fff}#tg456-withdrawals .tw-demo{font-size:11px;color:#e5cafa;white-space:nowrap}#tg456-withdrawals .tw-window{overflow-x:auto;scrollbar-width:none;border-radius:14px}#tg456-withdrawals .tw-window::-webkit-scrollbar{display:none}#tg456-withdrawals .tw-track{display:flex;width:max-content;animation:tg-withdraw-scroll 64s linear infinite}#tg456-withdrawals .tw-group{display:flex;gap:8px;padding-right:8px;flex:none}#tg456-withdrawals .tw-card{display:flex;align-items:center;gap:9px;width:205px;padding:9px 11px;border:1px solid #633284;border-radius:12px;background:linear-gradient(120deg,#180c28,#301343);min-height:68px}#tg456-withdrawals .tw-bank{width:32px;height:32px;object-fit:contain;border-radius:10px;flex:none}#tg456-withdrawals .tw-details{min-width:0}#tg456-withdrawals .tw-user{font-size:11px;font-weight:bold;white-space:nowrap}#tg456-withdrawals .tw-amount{font-size:18px;color:#58dfb1;font-weight:bold;line-height:1.4;white-space:nowrap}#tg456-withdrawals .tw-amount small{font-size:11px}#tg456-withdrawals .tw-note{font-size:10px;color:#bfaacf;margin-top:2px}#tg456-withdrawals:hover .tw-track,#tg456-withdrawals:focus-within .tw-track{animation-play-state:paused}@keyframes tg-withdraw-scroll{to{transform:translateX(-50%)}}@media(max-width:600px){#tg456-withdrawals{margin:12px auto}#tg456-withdrawals h2{font-size:14px}#tg456-withdrawals .tw-head{gap:6px;padding:8px 10px}#tg456-withdrawals .tw-card{width:190px;padding:8px 10px;min-height:64px}#tg456-withdrawals .tw-amount{font-size:17px}#tg456-withdrawals .tw-demo{font-size:10px}}@media(prefers-reduced-motion:reduce){#tg456-withdrawals .tw-track{animation:none}#tg456-withdrawals .tw-group[aria-hidden=true]{display:none}}`;
  document.head.append(style);
  const head=el('div','tw-head');
  head.append(el('h2','','ยอดถอนล่าสุด'),el('span','tw-demo','ข้อมูลตัวอย่าง'));
