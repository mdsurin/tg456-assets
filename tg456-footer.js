...
(function(){
 ...
 function install(){
  ...
  function render(){
   ...
   status.textContent=feed?.error?'ดึงข้อมูลผลหวยไม่สำเร็จ • กำลังแสดงข้อมูลที่บันทึกไว้':'';
  }
